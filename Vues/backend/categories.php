                    ...
                    <section class="content-header z-depth-1">
                        ...
                        <div class="header-title">
                            ...
                            <ul class="link hidden-xs">
                                ...
                                <li><a href="?p=categories">Catégories Familles</a></li>
                            </ul>
                        </div>
                    </section>
                    <!-- page section -->
                                    ...
                                    <div  style="height:60px;" class="card-header">
                                        ...
                                        <h2>Responsive table</h2> -->
                                          ...
                                          <div style="float:right;" id="right_side">
                                                 ...
                                                 <button data-toggle="modal" data-target="#ajouter_famille" class="btn btn-sm ajouter_famille_button">Ajouter  une  Catégorie</button>
                                          </div>
                                    </div>
                                                ...
                                                <tbody>
                                                  ...
                                                  <?php 
                                                    ...
                                                    foreach($query_result1 as $famille){
                                                        ...
                                                        $famille1 = $famille2->getRow("SELECT * FROM ec_sous_famille WHERE sous_famille_id=?",array($famille->sous_famille_id));

                                                        ?> 

                                                         <tr id="ligne<?=$famille->categorie_id;?>">
                                                        <td>
                                                            <input type="checkbox" id="test<?=$famille->categorie_id;?>" name="customer_id[]" class="many_deletes" value="<?=$famille->categorie_id;?>" />
                                                            <!-- <label for="test<?=$famille->categorie_id;?>"></label> -->
                                                        </td>

                                                        <td><?=$famille1->sous_famille_libelle;?></td>
                                                        <td><?=$famille->categorie_libelle;?></td>
                                                        
                                                        <td>

                                                        <button data-voir_id="<?=$famille->categorie_id;?>" data-libelle="<?=$famille->categorie_libelle;?>" data-description="<?=$famille->categorie_description;?>" data-image="<?=$famille->categorie_image;?>" data-toggle="modal" data-target="#voir_famille" class="btn btn-sm voir" data-toggle="tooltip" data-placement="left" title="Voir"><i class="fa fa-eye" aria-hidden="true"></i></button>


                                                            <button data-modifier_id="<?=$famille->categorie_id;?>" data-libelle="<?=$famille->categorie_libelle;?>" data-description="<?=$famille->categorie_description;?>" data-image="<?=$famille->categorie_image;?>" data-parent_libelle="<?=$famille1->sous_famille_libelle;?>" data-parent_id="<?=$famille1->sous_famille_id;?>" data-toggle="modal" data-target="#modifier_famille" class="btn btn-sm modifier" data-toggle="tooltip" data-placement="left" title="Mettre à Jour"><i class="fa fa-pencil" aria-hidden="true"></i></button>


                                                            <button data-supprimer_id="<?=$famille->categorie_id;?>" class="btn btn-danger btn-sm supprimer" data-toggle="tooltip" data-placement="right" title="Supprimer "><i class="fa fa-trash-o" ></i></button>
                                                        </td>
                                                    </tr>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form  id="ajouter_famille_form">
                                                 <div class="form-group">
                                                        <label style="color:black;font-size:15px;" for="">Sous Famille</label>
                                                        ...
                                                        <?php
                                                             ...
                                                             foreach($query_result2 as $famille_value){
                                                                   ...
                                                                   <option value="<?=$famille_value->sous_famille_id;?>"><?=$famille_value->sous_famille_libelle;?></option>
                                                ...
                                                <div class="form-group">
                                                    <label style="color:black;font-size:15px;" for="famille_libelle">Catégorie Titre <strong>*</strong></label>
                                                ...
                                                <div class="form-group">
                                                    <label style="color:black;font-size:15px;" for="famille_description">Catégorie Description</label>
                                                ...
                                                <div style="margin-bottom:20px;" class="form-group">
                                                    <label style="color:black;font-size:15px;" for="famille_image">Catégorie Image</label>
                                              ...
                                              success:function(data){
                                                     ...
                                                     if(data.code==1){
                                                        ...
                                                        setInterval(function(){
                                                          ...
                                                          window.open("?p=categories","_self");
                                                        }
