                                    ...
                                    <div  style="height:60px;" class="card-header">
                                        ...
                                        <h2>Responsive table</h2> -->
                                          ...
                                          <div style="float:right;" id="right_side">
                                                 ...
                                                 <button data-toggle="modal" data-target="#ajouter_famille" class="btn btn-sm ajouter_famille_button">Ajouter une marque</button>
                                          </div>
                                    </div>
                                                  ...
                                                  <?php 
                                                    ...
                                                    foreach($query_result1 as $famille){
                                                        ...
                                                        ?> 
                                                         ...
                                                         <tr id="ligne<?=$famille->marque_id;?>">
                                                        <td>
                                                            <input type="checkbox" id="test<?=$famille->marque_id;?>" name="customer_id[]" class="many_deletes" value="<?=$famille->marque_id;?>" />
                                                            <!-- <label for="test<?=$famille->marque_id;?>"></label> -->
                                                        </td>
                                                        <td><?=$famille->marque_libelle;?></td>
                                                        ...
                                                        <!-- <button data-voir_id="<?=$famille->famille_id;?>" data-libelle="<?=$famille->famille_libelle;?>" data-description="<?=$famille->famille_description;?>" data-image="<?=$famille->famille_image;?>" data-toggle="modal" data-target="#voir_famille" class="btn btn-sm voir" data-toggle="tooltip" data-placement="left" title="Voir"><i class="fa fa-eye" aria-hidden="true"></i></button> -->
                                                            ...
                                                            <button data-modifier_id="<?=$famille->marque_id;?>" data-libelle="<?=$famille->marque_libelle;?>"  data-toggle="modal" data-target="#modifier_famille" class="btn btn-sm modifier" data-toggle="tooltip" data-placement="left" title="Mettre à Jour"><i class="fa fa-pencil" aria-hidden="true"></i></button>


                                                            <button data-supprimer_id="<?=$famille->marque_id;?>" class="btn btn-danger btn-sm supprimer" data-toggle="tooltip" data-placement="right" title="Supprimer "><i class="fa fa-trash-o" ></i></button>
                                                        </td>
                                                    </tr>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form  id="ajouter_famille_form">
                                                <div class="form-group">
                                                    <label style="color:black;font-size:15px;" for="famille_libelle">Marque libelle <strong>*</strong></label>
                                ...
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form  id="update_famille_form">
                                                <div class="form-group">
                                                    <label style="color:black;font-size:15px;" for="famille_libelle_modifier">Marque libelle <strong>*</strong></label>
                           ...
                           e.preventDefault();
                             ...
                             if(famille_libelle==""){
                                ...
                                errors.push("ce champ est obligatoire");
                                  ...
                                  $("#famille_libelle_message").text("le libelle de la marque est obligatoire").addClass("text-danger");
                             }else{
                                              ...
                                              success:function(data){
                                                     ...
                                                     if(data.code==1){
                                                        ...
                                                        setInterval(function(){
                                                          ...
                                                          window.open("?p=marque_articles","_self");
                                                        }
                                                        ...
                                                        swal({
                                                            ...
                                                            cancelButtonText: 'Annuler !',
                                                             ...
                                                             $.ajax({
                                                                ...
                                                                url:"?p=delete_marque_article_run",
                                                                method:"POST",
                                                                dataType:"JSON",
                                                                data:{id:id},
                                                                success:function(data){
                           ...
                           e.preventDefault();
                             ...
                             if(famille_libelle==""){
                                ...
                                errors.push("ce champ est obligatoire");
                                  ...
                                  $("#famille_libelle_message_modifier").text("le libelle de la marque est obligatoire").addClass("text-danger");
                             }else{
                             ...
                             if(errors.length==0){
                                    ...
                                    //   formData.append('id',id);
                                        ...
                                        $.ajax({
                                              ...
                                              url:"?p=update_marque_article_run",
                                              method:"POST",
                                              dataType:"JSON",
                ...
                swal({
                                                            ...
                                                            cancelButtonText: 'Annuler!',
                                                             ...
                                                             $.ajax({
                                                                ...
                                                                url:"?p=many_deletes_marque_article",
                                                                method:"POST",
                                                                dataType:"JSON",
                                                                data:{id:id},
                                                                success:function(data){
