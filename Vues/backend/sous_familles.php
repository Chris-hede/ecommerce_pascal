<?php include('_header.php') ;?>
                                    ...
                                    <div  style="height:60px;" class="card-header">
                                        ...
                                        <h2>Responsive table</h2> -->
                                          ...
                                          <div style="float:right;" id="right_side">
                                                 ...
                                                 <button data-toggle="modal" data-target="#ajouter_famille" class="btn btn-sm ajouter_famille_button">Ajouter  une Sous Famille</button>
                                          </div>
                                    </div>
                                                ...
                                                <tbody>
                                                  ...
                                                  <?php 
                                                    ...
                                                    foreach($query_result1 as $famille){
                                                        ...
                                                        $famille1 = $famille2->getRow("SELECT * FROM ec_famille WHERE famille_id=?",array($famille->famille_id));

                                                        ?> 

                                                         <tr id="ligne<?=$famille->sous_famille_id;?>">
                                                        <td>
                                                            <input type="checkbox" id="test<?=$famille->sous_famille_id;?>" name="customer_id[]" class="many_deletes" value="<?=$famille->sous_famille_id;?>" />
                                                            <!-- <label for="test<?=$famille->sous_famille_id;?>"></label> -->
                                                        </td>

                                                        <td><?=$famille1->famille_libelle;?></td>
                                                        <td><?=$famille->sous_famille_libelle;?></td>
                                                        
                                                        <td>

                                                        <button data-voir_id="<?=$famille->sous_famille_id;?>" data-libelle="<?=$famille->sous_famille_libelle;?>" data-description="<?=$famille->sous_famille_description;?>" data-image="<?=$famille->sous_famille_image;?>" data-toggle="modal" data-target="#voir_famille" class="btn btn-sm voir" data-toggle="tooltip" data-placement="left" title="Voir"><i class="fa fa-eye" aria-hidden="true"></i></button>


                                                            <button data-modifier_id="<?=$famille->sous_famille_id;?>" data-libelle="<?=$famille->sous_famille_libelle;?>" data-description="<?=$famille->sous_famille_description;?>" data-image="<?=$famille->sous_famille_image;?>" data-parent_libelle="<?=$famille1->famille_libelle;?>" data-parent_id="<?=$famille1->famille_id;?>" data-toggle="modal" data-target="#modifier_famille" class="btn btn-sm modifier" data-toggle="tooltip" data-placement="left" title="Mettre à Jour"><i class="fa fa-pencil" aria-hidden="true"></i></button>


                                                            <button data-supprimer_id="<?=$famille->sous_famille_id;?>" class="btn btn-danger btn-sm supprimer" data-toggle="tooltip" data-placement="right" title="Supprimer "><i class="fa fa-trash-o" ></i></button>
                                                        </td>
                                                    </tr>
                                ...
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title">Ajouter une Sous Famille d'articles</h4>
                                        </div>
                                        ...
                                        <form  id="ajouter_famille_form">
                                                 <div class="form-group">
                                                        <label style="color:black;font-size:15px;" for="">Famille</label>
                                                        <select class="form-control" name="famille1" id="famille1">

                                                        <option value=""></option>

                                                        <?php
                                                        
                                                             foreach($query_result2 as $famille_value){


                                                                   ?>

                                                                   <option value="<?=$famille_value->famille_id;?>"><?=$famille_value->famille_libelle;?></option>
                                                ...
                                                <div class="form-group">
                                                    <label style="color:black;font-size:15px;" for="famille_libelle">Sous Famille Titre <strong>*</strong></label>
                                                ...
                                                <div class="form-group">
                                                    <label style="color:black;font-size:15px;" for="famille_description">Sous Famille Description</label>
                                                ...
                                                <div style="margin-bottom:20px;" class="form-group">
                                                    <label style="color:black;font-size:15px;" for="famille_image">Sous Famille Image</label>
                    ...
                    <div style="width:100%;" class="modal animated fadeIn" id="voir_famille" role="dialog">
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                            <h4 class="modal-title">Aperçu Sous Famille</h4>
                                        </div>
                                        <div class="modal-body">
                    ...
                    <div style="width:100%;" class="modal animated fadeIn" id="modifier_famille" role="dialog">
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                            <h4 class="modal-title">Mettre à Jour sous une Famille </h4>
                                        </div>
                                        <div class="modal-body">
                                        ...
                                        <form  id="update_famille_form">
                                                 ...
                                                 <div class="form-group">
                                                 <label style="color:black;font-size:15px;" for="famille_libelle_modifier">Famille <strong>*</strong></label>

                                                         <select name="famille1_modifier" id="famille1_modifier" class="form-control">
                                                             
                                                         <option id="famille1_modifier_avant" value=""></option>
                                                         <?php
                                                   ...
                                                   ?>
                                                         ...
                                                         <small id="message1_modifier"></small>
                                                 </div>
                                                <div class="form-group">
                                                    <label style="color:black;font-size:15px;" for="famille_libelle_modifier">Sous Famille Titre <strong>*</strong></label>
                    ...
                    $("#ajouter_famille_form").submit(function(e){
                           ...
                           e.preventDefault();
                             ...
                             if(famille_cle==""){
                                ...
                                errors.push("ce champ1 est obligatoire");

                                  $("#message1").text("ce champ est obligatoire").addClass("text-danger");
                             }else{

                                $("#message1").text("").removeClass("text-danger");
                                 errors = errors.filter(function(value, index, arr)  { 
                                        return value !="ce champ1 est obligatoire";
                                    });
                             }
                             ...
                             if(errors.length==0){
                                    ...
                                    if(!famille_image){
                                      ...
                                      formData.append('famille_cle',famille_cle);
                                              ...
                                              success:function(data){
                                                     ...
                                                     if(data.code==1){
                                                        ...
                                                        setInterval(function(){
                                                          ...
                                                          window.open("?p=sous_familles","_self");
                                                        }
    ...
    //   this part is designed to delete a single family of  a product
                ...
                $(".supprimer").click(function(){
                        ...
                        var id = $(this).attr("data-supprimer_id");
                                                        ...
                                                        swal({
                                                            title: 'voulez vous vraiment supprimer cette sous  famille ?',
 ...
 // for this part , I will make the editing
    ...
    $(".modifier").click(function(){
        ...
        var famille_description = $(this).attr("data-description");
        var famille_image = $(this).attr("data-image");
        var famille_parent_libelle = $(this).attr("data-parent_libelle");
        var famille_parent_id = $(this).attr("data-parent_id");

        // alert(famille_parent_libelle);
        // alert(famille_parent_id);


        $("#famille_libelle_modifier").val(famille_libelle);
        $("#famille_description_modifier").val(famille_description);
        $("#famille1_modifier_avant").val(famille_parent_id);
        $("#famille1_modifier_avant").text(famille_parent_libelle);
        ...
        $("#message1_modifier").text("").removeClass("text-danger");
                    ...
                    $("#update_famille_form").submit(function(e){
                           ...
                           e.preventDefault();
                             ...
                             // retrieving data from form
                                ...
                                // var famille_image = $("#famille_image")[0].files[0];
                                var famille_parent_id = $("#famille1_modifier").val();
                             ...
                             if(errors.length==0){
                                    ...
                                    if(!famille_image){
                                      ...
                                      formData.append('famille_parent_id',famille_parent_id);
                ...
                swal({
                                                            ...
                                                            cancelButtonText: 'Annuler!',
                                                             ...
                                                             $.ajax({
                                                                ...
                                                                url:"?p=many_deletes_sous_famille",
                                                                method:"POST",
                                                                dataType:"JSON",
                                                                data:{id:id},
                                                                success:function(data){
