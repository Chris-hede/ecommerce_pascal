                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form  id="ajouter_famille_form">
                                                <div class="form-group">
                                                    <label style="color:black;font-size:15px;" for="famille_libelle">Taille libelle <strong>*</strong></label>
                    ...
                    <div style="width:100%;" class="modal animated fadeIn" id="modifier_famille" role="dialog">
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                            <h4 class="modal-title">Modifier une taille</h4>
                                        </div>
                                        <div class="modal-body">
                                        ...
                                        <form  id="update_famille_form">
                                                <div class="form-group">
                                                    <label style="color:black;font-size:15px;" for="famille_libelle_modifier">Taille libelle <strong>*</strong></label>
    ...
    //   this part is designed to delete a single family of  a product
                ...
                $(".supprimer").click(function(){
                        ...
                        var id = $(this).attr("data-supprimer_id");
                                                        ...
                                                        swal({
                                                            title: 'voulez vous vraiment supprimer cette taille ?',
                             ...
                             if(errors.length==0){
                                    ...
                                    //   formData.append('id',id);
                                        ...
                                        $.ajax({
                                              ...
                                              url:"?p=update_taille_pointure_run",
                                              method:"POST",
                                              dataType:"JSON",
                ...
                swal({
                                                            ...
                                                            cancelButtonText: 'Annuler!',
                                                             ...
                                                             $.ajax({
                                                                ...
                                                                url:"?p=many_deletes_taille_pointure",
                                                                method:"POST",
                                                                dataType:"JSON",
                                                                data:{id:id},
                                                                success:function(data){
