...
<html lang="en">
    <head>
        ...
        <link rel="shortcut icon" href="assets/assets2/dist/img/ico/fav.png">

        <!-- Start Global Mandatory Style
        =====================================================================-->
        <!-- jquery-ui css -->
        <link href="assets/assets2/plugins/jquery-ui-1.12.1/jquery-ui.min.css" rel="stylesheet" type="text/css"/> 
        <!-- materialize css -->
        <link href="assets/assets2/plugins/materialize/css/materialize.min.css" rel="stylesheet">
        <!-- Bootstrap css-->
        <link href="assets/assets2/bootstrap/css/bootstrap.min.css" rel="stylesheet">
        <!-- Material Icons CSS -->
        <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
        <!-- Animation Css -->
        <link href="assets/assets2/plugins/animate/animate.css" rel="stylesheet" />
        <!-- simplebar scroll css -->
        <link href="assets/assets2/plugins/simplebar/dist/simplebar.css" rel="stylesheet" type="text/css"/>
        <!-- mCustomScrollbar css -->
        <link href="assets/assets2/plugins/malihu-custom-scrollbar/jquery.mCustomScrollbar.css" rel="stylesheet" type="text/css"/>
        <!-- images-grid -->
        <link href="assets/assets2/plugins/images-grid/src/images-grid.css" rel="stylesheet" type="text/css"/>
        <!-- lightbox2 -->
        <link href="assets/assets2/plugins/lightbox2/dist/css/lightbox.min.css" rel="stylesheet" type="text/css"/>
        <!-- Font Awesome -->
        <link href="assets/assets2/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css"/>
        <!-- custom CSS -->
        <link href="assets/assets2/dist/css/stylematerial.css" rel="stylesheet">
    ...
    <body> 
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top">
                ...
                <a class="navbar-brand pull-left" href="index.html">
                    <img src="assets/assets2/dist/img/logo3.png" alt="logo" width="205" height="60">
                </a>
                <a id="menu-toggle">
                    ...
                    <ul class="navbar navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-message mCustomScrollbar animated bounceIn dropdown-notification" data-mcs-theme="minimal">
                                <li class="list-details">
                                    ...
                                    <a href="#">
                                        <div class="pro-images pull-left">
                                            <img src="assets/assets2/dist/img/avatar4.png" class="img-circle" height="40" width="40" alt="User Image">
                                        </div>
                                ...
                                <li class="list-details">
                                    ...
                                    <a href="#">
                                        <div class="pro-images pull-left">
                                            <img src="assets/assets2/dist/img/avatar3.png" class="img-circle" height="40" width="40" alt="User Image">
                                        </div>
                                ...
                                <li class="list-details">
                                    ...
                                    <a href="#">
                                        <div class="pro-images pull-left">
                                            <img src="assets/assets2/dist/img/avatar2.png" class="img-circle" height="40" width="40" alt="User Image">
                                        </div>
                        ...
                        <li class="dropdown">
                            <a class='dropdown-button user-pro' href='#' data-activates='dropdown-user'>
                                <img src="assets/assets2/dist/img/avatar5.png" class="img-circle" height="45" width="50" alt="User Image">
                            </a>
                                    ...
                                    <div class="card-content">
                                        <div class='list-group gallery'>
                                            <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
                                                <a class="fancybox thumbnail example-image-link" href="assets/assets2/dist/img/imgs/1.jpg" data-lightbox="example-1"><img class="example-image" src="assets/assets2/dist/img/imgs/1.jpg" alt="image-1" /></a>
                                            </div> <!-- col-6 / end -->
                                            <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
                                                <a class="fancybox thumbnail example-image-link" href="assets/assets2/dist/img/imgs/2.jpg" data-lightbox="example-2"><img class="example-image" src="assets/assets2/dist/img/imgs/2.jpg" alt="image-2" /></a>
                                            </div> <!-- col-6 / end -->
                                            <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
                                                <a class="fancybox thumbnail example-image-link" href="assets/assets2/dist/img/imgs/3.jpg" data-lightbox="example-3"><img class="example-image" src="assets/assets2/dist/img/imgs/3.jpg" alt="image-3" /></a>
                                            </div> <!-- col-6 / end -->
                                            <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
                                                <a class="fancybox thumbnail example-image-link" href="assets/assets2/dist/img/imgs/4.jpg" data-lightbox="example-4"><img class="example-image" src="assets/assets2/dist/img/imgs/4.jpg" alt="image-4" /></a>
                                            </div> <!-- col-6 / end -->
                                            <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
                                                <a class="fancybox thumbnail example-image-link" href="assets/assets2/dist/img/imgs/5.jpg" data-lightbox="example-5"><img class="example-image" src="assets/assets2/dist/img/imgs/5.jpg" alt="image-5" /></a>
                                            </div> <!-- col-6 / end -->
                                            <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
                                                <a class="fancybox thumbnail example-image-link" href="assets/assets2/dist/img/imgs/6.jpg" data-lightbox="example-6"><img class="example-image" src="assets/assets2/dist/img/imgs/6.jpg" alt="image-6" /></a>
                                            </div> <!-- col-6 / end -->
                                            <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
                                                <a class="fancybox thumbnail example-image-link" href="assets/assets2/dist/img/imgs/7.jpg" data-lightbox="example-7"><img class="example-image" src="assets/assets2/dist/img/imgs/7.jpg" alt="image-7" /></a>
                                            </div> <!-- col-6 / end -->
                                        </div> <!-- list-group / end -->
                                    </div>
                                </div>
        ...
        <!-- lightbox2 -->
        <script src="assets/assets2/plugins/lightbox2/dist/js/lightbox-plus-jquery.min.js" type="text/javascript"></script>
        <!-- metismenu-master -->
        <script src="assets/assets2/plugins/metismenu-master/dist/metisMenu.min.js" type="text/javascript"></script>
        <!-- images-grid -->
        <script src="assets/assets2/plugins/images-grid/src/images-grid.js" type="text/javascript"></script>
        <!-- m-custom-scrollbar -->
        ...
        <script>
            ...
            $(imggellary).imagesGrid({
                images: [
                    {src: 'assets/assets2/dist/img/imgs/1.jpg', thumbnail: 'assets/assets2/dist/img/imgs/1-thumbnail.jpg'},
                    {src: 'assets/assets2/dist/img/imgs/2.jpg', alt: 'Nature', title: 'Nature'},
                    'assets/assets2/dist/img/imgs/3.jpg',
                    {src: 'assets/assets2/dist/img/imgs/4.jpg', caption: 'The long way'},
                    'assets/assets2/dist/img/imgs/5.jpg',
                    'assets/assets2/dist/img/imgs/6.jpg',
                    'assets/assets2/dist/img/imgs/7.jpg'
                ],
                align: true
            });
        </script>
