<nav style="background-color:#020202;height:17%;" class="navbar navbar-inverse navbar-fixed-top">
                <!-- Logo -->
                <a class="navbar-brand pull-left" href="?p=dashboard">
                    <img style="width:70%;height:120%;" src="assets/assets2/dist/img/krshop.jpg" alt="logo" width="205" height="60">
                </a>
                <a id="menu-toggle">
                    ...
                    <ul class="navbar navbar-right">
                        ...
                        <li class="dropdown">
                            <a class="dropdown-toggle" data-toggle="dropdown">
                                <i style="color: #C49635;" class="material-icons">notifications_active</i><span class="numbers">8</span>
                            </a>
                        ...
                        <li class="list-details dropdown">
                            <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                                <i style="color: #C49635;"  class="material-icons">assignment</i><span class="numbers">6+</span>
                            </a>
                        ...
                        <li class="dropdown">
                            <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                                <i style="color: #C49635;"  class="material-icons">message</i><span class="numbers">9+</span>
                            </a>
                            <ul class="dropdown-menu dropdown-message mCustomScrollbar animated bounceIn" data-mcs-theme="minimal">
                                <li class="list-details">
                                    <!-- start tasks -->
                        ...
                        <!--user profile-->
                        <li class="dropdown">
                            <a style="background:none;" class='dropdown-button user-pro' href='#' data-activates='dropdown-user'>
                                <img src="assets/assets2/dist/img/rk shorp.jpg" class="img-circle" height="45" width="50" alt="User Image">
                            </a>
