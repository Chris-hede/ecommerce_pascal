                                    ...
                                    <div  style="height:60px;" class="card-header">
                                        ...
                                        <h2>Responsive table</h2> -->
                                          ...
                                          <div style="float:right;" id="right_side">
                                                 ...
                                                 <button data-toggle="modal" data-target="#ajouter_famille" class="btn btn-sm ajouter_famille_button">Ajouter une couleur</button>
                                          </div>
                                    </div>
                                                  ...
                                                  <?php 
                                                    ...
                                                    foreach($query_result1 as $famille){
                                                        ...
                                                        ?> 
                                                         ...
                                                         <tr id="ligne<?=$famille->article_couleur_id;?>">
                                                        <td>
                                                            <input type="checkbox" id="test<?=$famille->article_couleur_id;?>" name="customer_id[]" class="many_deletes" value="<?=$famille->article_couleur_id;?>" />
                                                            <!-- <label for="test<?=$famille->article_couleur_id;?>"></label> -->
                                                        </td>
                                                        <td><?=$famille->article_couleur_libelle;?></td>
                                                        ...
                                                        <!-- <button data-voir_id="<?=$famille->famille_id;?>" data-libelle="<?=$famille->famille_libelle;?>" data-description="<?=$famille->famille_description;?>" data-image="<?=$famille->famille_image;?>" data-toggle="modal" data-target="#voir_famille" class="btn btn-sm voir" data-toggle="tooltip" data-placement="left" title="Voir"><i class="fa fa-eye" aria-hidden="true"></i></button> -->
                                                            ...
                                                            <button data-modifier_id="<?=$famille->article_couleur_id;?>" data-libelle="<?=$famille->article_couleur_libelle;?>"  data-toggle="modal" data-target="#modifier_famille" class="btn btn-sm modifier" data-toggle="tooltip" data-placement="left" title="Mettre à Jour"><i class="fa fa-pencil" aria-hidden="true"></i></button>


                                                            <button data-supprimer_id="<?=$famille->article_couleur_id;?>" class="btn btn-danger btn-sm supprimer" data-toggle="tooltip" data-placement="right" title="Supprimer "><i class="fa fa-trash-o" ></i></button>
                                                        </td>
                                                    </tr>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form  id="ajouter_famille_form">
                                                <div class="form-group">
                                                    <label style="color:black;font-size:15px;" for="famille_libelle">Couleur libelle <strong>*</strong></label>
                    ...
                    <div style="width:100%;" class="modal animated fadeIn" id="modifier_famille" role="dialog">
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                            <h4 class="modal-title">Modifier une Couleur</h4>
                                        </div>
                                        <div class="modal-body">
                                        ...
                                        <form  id="update_famille_form">
                                                <div class="form-group">
                                                    <label style="color:black;font-size:15px;" for="famille_libelle_modifier">Couleur libelle <strong>*</strong></label>
                           ...
                           e.preventDefault();
                             ...
                             if(famille_libelle==""){
                                ...
                                errors.push("ce champ est obligatoire");
                                  ...
                                  $("#famille_libelle_message").text("le libelle de la taille est obligatoire").addClass("text-danger");
                             }else{
                           ...
                           e.preventDefault();
                             ...
                             if(famille_libelle==""){
                                ...
                                errors.push("ce champ est obligatoire");
                                  ...
                                  $("#famille_libelle_message_modifier").text("le libelle de la couleur est obligatoire").addClass("text-danger");
                             }else{
                             ...
                             if(errors.length==0){
                                    ...
                                    //   formData.append('id',id);
                                        ...
                                        $.ajax({
                                              ...
                                              url:"?p=update_article_couleur_run",
                                              method:"POST",
                                              dataType:"JSON",
                ...
                swal({
                                                            ...
                                                            cancelButtonText: 'Annuler!',
                                                             ...
                                                             $.ajax({
                                                                ...
                                                                url:"?p=many_deletes_couleur_article",
                                                                method:"POST",
                                                                dataType:"JSON",
                                                                data:{id:id},
                                                                success:function(data){
