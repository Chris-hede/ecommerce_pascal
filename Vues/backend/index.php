<?php include('_header.php'); ?>
                                        ...
                                        <ul class="chat_list">
                                            <li class="clearfix">
                                                <div class="chat-avatar">
                                                    <img src="assets/assets2/dist/img/avatar4.png" alt="male">
                                            ...
                                            <li class="clearfix odd">
                                                <div class="chat-avatar">
                                                    <img src="assets/assets2/dist/img/avatar5.png" alt="Female">
                                            ...
                                            <li class="clearfix">
                                                <div class="chat-avatar">
                                                    <img src="assets/assets2/dist/img/avatar2.png" alt="male">
                                            ...
                                            <div class="message_widgets">
                                                <a href="#">
                                                    <div class="inbox-item">
                                                        <div class="inbox-item-img"><img src="assets/assets2/dist/img/avatar.png" class="img-circle" alt=""></div>
                                                ...
                                                <a href="#">
                                                    <div class="inbox-item">
                                                        <div class="inbox-item-img"><img src="assets/assets2/dist/img/avatar2.png" class="img-circle" alt=""></div>
                                                ...
                                                <a href="#">
                                                    <div class="inbox-item">
                                                        <div class="inbox-item-img"><img src="assets/assets2/dist/img/avatar3.png" class="img-circle" alt=""></div>
                                                ...
                                                <a href="#">
                                                    <div class="inbox-item">
                                                        <div class="inbox-item-img"><img src="assets/assets2/dist/img/avatar4.png" class="img-circle" alt=""></div>
                                                ...
                                                <a href="#">
                                                    <div class="inbox-item">
                                                        <div class="inbox-item-img"><img src="assets/assets2/dist/img/avatar5.png" class="img-circle" alt=""></div>
        ...
        <!-- SlimScroll -->
        <script src="assets/assets2/plugins/slimScroll/jquery.slimscroll.min.js" type="text/javascript"></script>
        <!-- m-custom-scrollbar -->
        ...
        <!-- Start Page Lavel Plugins
             =====================================================================-->
        <!-- Sparkline js -->
        <script src="assets/assets2/plugins/sparkline/sparkline.min.js" type="text/javascript"></script>
        <!-- Counter js -->
        <script src="assets/assets2/plugins/counterup/jquery.counterup.min.js" type="text/javascript"></script>
        <!-- ChartJs JavaScript -->
        <script src="assets/assets2/plugins/chartJs/Chart.min.js" type="text/javascript"></script>
        <!-- Monthly js -->
        <script src="assets/assets2/plugins/monthly/monthly.js" type="text/javascript"></script>
