                                    ...
                                    <div  style="height:60px;" class="card-header">
                                        ...
                                        <h2>Responsive table</h2> -->
                                          ...
                                          <div style="float:right;" id="right_side">
                                                 ...
                                                 <button data-toggle="modal" data-target="#ajouter_famille" class="btn btn-sm ajouter_famille_button">Ajouter une Famille</button>
                                          </div>
                                    </div>
                                                  ...
                                                  <?php 
                                                    ...
                                                    foreach($query_result1 as $famille){
                                                        ...
                                                        ?> 
                                                         ...
                                                         <tr id="ligne<?=$famille->famille_id;?>">
                                                        <td>
                                                            <input type="checkbox" id="test<?=$famille->famille_id;?>" name="customer_id[]" class="many_deletes" value="<?=$famille->famille_id;?>" />
                                                            <!-- <label for="test<?=$famille->famille_id;?>"></label> -->
                                                        ...
                                                        <button data-voir_id="<?=$famille->famille_id;?>" data-libelle="<?=$famille->famille_libelle;?>" data-description="<?=$famille->famille_description;?>" data-image="<?=$famille->famille_image;?>" data-toggle="modal" data-target="#voir_famille" class="btn btn-sm voir" data-toggle="tooltip" data-placement="left" title="Voir"><i class="fa fa-eye" aria-hidden="true"></i></button>
                                                            ...
                                                            <button data-modifier_id="<?=$famille->famille_id;?>" data-libelle="<?=$famille->famille_libelle;?>" data-description="<?=$famille->famille_description;?>" data-image="<?=$famille->famille_image;?>" data-toggle="modal" data-target="#modifier_famille" class="btn btn-sm modifier" data-toggle="tooltip" data-placement="left" title="Mettre à Jour"><i class="fa fa-pencil" aria-hidden="true"></i></button>


                                                            <button data-supprimer_id="<?=$famille->famille_id;?>" class="btn btn-danger btn-sm supprimer" data-toggle="tooltip" data-placement="right" title="Supprimer "><i class="fa fa-trash-o" ></i></button>
                                                        </td>
                                                    </tr>
